config = {
    ...
    ['lang'] = {
        ...
        ['bassSmoke'] = 'Fumaça no Grave',
        ['bassSparklers'] = 'Faíscas no Grave',
        ['triggerSmoke'] = 'Ativar Fumaça',
        ['triggerSparklers'] = 'Ativar Faíscas',
        ...
        ['sourceError'] = 'Erro ao reproduzir mídia.',
        ...
        ['urlPlaceholder'] = 'URL do YouTube ou Twitch',
        ['frame'] = 'Frame',
